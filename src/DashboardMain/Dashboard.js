        ...
        <div className="h-100 bg-light">
            ...
            <div className="row w-100 bg-light">
                <Navbar className="col-md-2 d-none d-md-block bg-light sidebar">
                    ...
                    <hr/>
                    <Button variant="light outline-primary" className="mt-2 w-100" onClick={() => setComponent('GT3Signup')}><a href='#'>Register for ACC - 2022 ISDA Porsche Cup Challenge - Summer Season</a></Button>
                    <Button variant="light outline-primary" className="mt-2 w-100"><a href='https://forms.gle/z1H4E2iJmo9fwL4s9'>Livery Upload for Porsche Cup Challenge - Summer Season</a></Button>
                    <hr/>
                        ...
                        <div>
                            ...
                            <div className="row w-75 ml-auto mr-auto">
                                <div className="col-md-7 mr-auto ml-auto">
                                    ...
                                    <img className="img-fluid" alt="ACC - 2022 ISDA Porsche Cup Challenge - Summer Season" src="https://www.isdaracing.com/wp-content/uploads/2022/05/pcup_s3.jpg"></img>
                                    <h3 className="mt-2 link">Register for ACC - 2022 ISDA Porsche Cup Challenge - Summer Season</h3>
                                    </Link>
                                </div>
                            </div>
