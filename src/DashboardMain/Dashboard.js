                        ...
                        <div>
                            ...
                            <div className="row w-75 ml-auto mr-auto">
                                <div className="col-md-7 mr-auto ml-auto">
                                    ...
                                    <img className="img-fluid" alt="ACC - 2022 ISDA Ferrari Challenge USA - Summer Season" src="https://www.isdaracing.com/wp-content/uploads/2022/07/2022SummerUSAFerrariChallenge.png"></img>
                                    <h3 className="mt-2 link">Register for ACC - 2022 ISDA Ferrari Challenge USA - Summer Season</h3>
                                    </Link>
                                </div>
                            </div>
